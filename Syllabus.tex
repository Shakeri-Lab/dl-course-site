...
\item Attention & Transformers (Modules 8--9) $\rightarrow$ Homework 4: Add cross-attention to your GRU-based seq2seq model (submit with Module 9; see Module 8 note).
