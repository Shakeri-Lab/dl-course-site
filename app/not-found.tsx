  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center px-6">
      <div className="text-center max-w-md">
        <div className="mb-8">
          <h1 className="text-8xl font-bold text-[#002862] mb-4">404</h1>
        ...
        <div className="mt-8 pt-8 border-t border-slate-200">
          <p className="text-sm text-slate-500 mb-3">Looking for course materials?</p>
          <div className="flex flex-wrap gap-2 justify-center text-sm">
            <Link href="/setup" className="text-[#002862] hover:underline">Setup Guide</Link>
            <span className="text-slate-300">•</span>
            <Link href="/faq" className="text-[#002862] hover:underline">FAQ</Link>
            <span className="text-slate-300">•</span>
            <Link href="/module/1" className="text-[#002862] hover:underline">Module 1</Link>
          </div>
        </div>
      </div>
    </div>
