      ...
      <div className="mx-auto w-full max-w-5xl px-6 py-12">
        ...
        <Card className="mb-12 border border-white/30 bg-white/70 backdrop-blur-xl shadow-[0_32px_60px_-38px_rgba(0,40,98,0.45)]">
          ...
          <CardContent className="space-y-4">
            ...
            <p className="text-slate-600">
              Research paper: <a href="https://papers.nips.cc/paper_files/paper/2017/hash/3f5ee243547dee91fbd053c1c4a845aa-Abstract.html" target="_blank" rel="noopener noreferrer" className="text-[#002862] underline decoration-[#FFBA69]/70 underline-offset-4 hover:text-[#001a44]">Vaswani et al., "Attention Is All You Need" (NeurIPS 2017)</a>.
            </p>
            <div className="pt-2">
              <Button asChild>
                <a
